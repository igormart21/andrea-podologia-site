      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block mb-4 px-4 py-2 bg-[#6d9c7f] rounded-full border border-primary/10">
            <p className="text-sm font-medium text-primary-foreground">Como funciona</p>
          </div>
          <h2 className="text-4xl font-bold mb-6 text-foreground">Seu cuidado em 4 etapas</h2>
                  ...
                  <div className={`flex ${isEven ? 'sm:justify-end' : 'sm:justify-start'} justify-center`}>
                    <div className="bg-card border border-border/60 rounded-2xl p-6 shadow-sm max-w-md w-full">
                      <div className="flex items-center gap-4 mb-3">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#6d9c7f] to-accent/20 flex items-center justify-center">
